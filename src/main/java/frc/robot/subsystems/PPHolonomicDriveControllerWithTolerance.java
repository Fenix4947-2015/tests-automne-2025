...
public class PPHolonomicDriveControllerWithTolerance implements PathFollowingController {
   ...
   */
  public PPHolonomicDriveControllerWithTolerance(
      PIDConstants translationConstants, PIDConstants rotationConstants, double period, double xTolerance, double yTolerance, double angleTolerance) {
    this.xController =
        new PIDController(
    ...
    this.rotationController.setTolerance(angleTolerance);
  }
   ...
   */
  public PPHolonomicDriveControllerWithTolerance(
      PIDConstants translationConstants, PIDConstants rotationConstants, double xTolerance, double yTolerance, double angleTolerance) {
    this(translationConstants, rotationConstants, 0.02, xTolerance, yTolerance, angleTolerance);
  }
  ...
  public static void setRotationTargetOverride(
    ...
    PPHolonomicDriveControllerWithTolerance.rotationTargetOverride = rotationTargetOverride;
  }
  ...
  public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
    PPHolonomicDriveControllerWithTolerance.xFeedbackOverride = xFeedbackOverride;
  }
  ...
  public static void clearXFeedbackOverride() {
    PPHolonomicDriveControllerWithTolerance.xFeedbackOverride = null;
  }
  ...
  public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
    PPHolonomicDriveControllerWithTolerance.yFeedbackOverride = yFeedbackOverride;
  }
  ...
  public static void clearYFeedbackOverride() {
    PPHolonomicDriveControllerWithTolerance.yFeedbackOverride = null;
  }
  ...
  public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
    PPHolonomicDriveControllerWithTolerance.rotFeedbackOverride = rotationFeedbackOverride;
  }
  ...
  public static void clearRotationFeedbackOverride() {
    PPHolonomicDriveControllerWithTolerance.rotFeedbackOverride = null;
  }
